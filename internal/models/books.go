...
type Book struct {
	...
	Authorid    int64       `boil:"authorid" json:"authorid" toml:"authorid" yaml:"authorid"`
	Bookid      int64       `boil:"bookid" json:"bookid" toml:"bookid" yaml:"bookid"`
	Publisher   null.String `boil:"publisher" json:"publisher,omitempty" toml:"publisher" yaml:"publisher,omitempty"`
	Publisherid int64       `boil:"publisherid" json:"publisherid" toml:"publisherid" yaml:"publisherid"`
...
var BookWhere = struct {
	...
	Authorid:    whereHelperint64{field: "\"books\".\"authorid\""},
	Bookid:      whereHelperint64{field: "\"books\".\"bookid\""},
	Publisher:   whereHelpernull_String{field: "\"books\".\"publisher\""},
	Publisherid: whereHelperint64{field: "\"books\".\"publisherid\""},
	Title:       whereHelpernull_String{field: "\"books\".\"title\""},
	Year:        whereHelperint64{field: "\"books\".\"year\""},
	Descr:       whereHelpernull_String{field: "\"books\".\"descr\""},
	Isbn:        whereHelperstring{field: "\"books\".\"isbn\""},
	CreatedAt:   whereHelpernull_String{field: "\"books\".\"created_at\""},
	UpdatedAt:   whereHelpernull_String{field: "\"books\".\"updated_at\""},
}
...
var (
	bookAllColumns            = []string{"id", "authorid", "bookid", "publisher", "publisherid", "title", "year", "descr", "isbn", "created_at", "updated_at"}
	bookColumnsWithoutDefault = []string{"authorid", "bookid", "publisherid", "year", "isbn"}
	bookColumnsWithDefault    = []string{"id", "publisher", "title", "descr", "created_at", "updated_at"}
